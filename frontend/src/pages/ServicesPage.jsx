...
const ServicesPage = () => {
  ...
  const services = [
    { icon: Cog, title: 'Curated Catalogue', desc: 'Browse vetted electronics, fashion, home, beauty, and more—all in one place with clear pricing and details.', color: 'from-secondary-500 to-secondary-700' },
    { icon: Leaf, title: 'Sustainable Choices', desc: 'We highlight quality brands and responsible options where possible, so you can shop with confidence.', color: 'from-primary-500 to-primary-600' },
    ...
    { icon: Wrench, title: 'Installation & Training', desc: 'Professional installation services and comprehensive training to ensure you get the most out of your machinery from day one.', color: 'from-amber-500 to-secondary-600' },
    ...
    { icon: Users, title: 'Dealer Network', desc: 'Join our extensive dealer network spanning across India. Become a part of the Goldy Mart family and grow your business with us.', color: 'from-emerald-600 to-secondary-600' },
  ];
  ...
  return (
    <div ref={pageRef} className="overflow-hidden">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block bg-primary-100 text-primary-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">What We Offer</span>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">
              Comprehensive <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-500">Services</span>
            </h2>
          </div>
      ...
      <section className="process-section py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">
              Simple <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-500">Process</span>
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {processSteps.map((item, idx) => (
              <div key={idx} className="process-step relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all group">
                <div className="absolute -top-4 -left-4 w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center text-white font-black text-xl shadow-lg group-hover:scale-110 transition-transform">
                  {item.step}
                </div>
                <div className="pt-8">
      ...
      {/* Dealer Section */}
      <section className="dealer-section py-20 bg-gradient-to-br from-primary-700 via-primary-600 to-primary-600 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white mb-6">
                Become a <span className="text-yellow-400">Goldy Mart Dealer</span>
              </h2>
              <p className="text-white/80 text-lg mb-8 leading-relaxed">
                Partner with us to bring Goldy Mart to more customers in your region.
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 bg-white text-primary-700 px-8 py-4 rounded-full font-bold hover:shadow-xl transition-all hover:scale-105">
                Apply Now
                <ArrowRight size={20} />
              </Link>
            </div>
