...
const AboutPage = () => {
  ...
  const values = [
    { icon: Target, title: 'Our Mission', desc: 'To empower every Indian farmer with world-class agricultural machinery that enhances productivity and promotes sustainable farming.', color: 'from-blue-500 to-indigo-600' },
    ...
    { icon: Heart, title: 'Our Values', desc: 'Quality, integrity, innovation, and customer satisfaction are the pillars that guide everything we do at HeavyTech.', color: 'from-red-500 to-orange-600' },
  ];
  ...
  return (
    <div ref={pageRef} className="overflow-hidden">
      <SEOHead 
        ...
        description="Learn about HeavyTech Machinery - 15+ years of excellence in agricultural equipment. Serving 50,000+ farmers across 28+ states with premium quality machinery."
        keywords="about heavytech, agricultural machinery company india, farming equipment manufacturer, rice mill company"
        url="https://www.heavytechmachinery.com/about"
      />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="story-image relative pb-4 sm:pb-0">
              <div className="absolute -inset-4 bg-gradient-to-r from-green-500/20 to-yellow-500/20 rounded-3xl blur-2xl hidden sm:block" aria-hidden />
              <img 
              ...
              <div className="relative sm:absolute sm:-bottom-6 sm:-right-6 mt-4 sm:mt-0 mx-auto sm:mx-0 max-w-full sm:max-w-[280px] bg-white p-4 sm:p-6 rounded-2xl shadow-xl">
                <Quote className="text-green-600 mb-2" size={28} />
                <p className="text-gray-700 font-medium italic text-sm sm:text-base">"We create the future of farming"</p>
              </div>
            </div>

            <div className="story-content">
              <span className="inline-block bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">Our Story</span>
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-6">
                A Journey of <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500">Innovation & Trust</span>
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">
              Our Core <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500">Values</span>
            </h2>
          </div>
      ...
      {/* Stats Section */}
      <section className="stats-section py-20 bg-gradient-to-br from-green-700 via-green-600 to-emerald-600 relative overflow-hidden">
      ...
      <section className="milestones-section py-20 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="milestone-title text-center mb-16">
            <span className="inline-block bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">Our Journey</span>
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">
              Key <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500">Milestones</span>
            </h2>
          ...
          <div className="relative">
            ...
            <div className="timeline-line absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-green-500 via-emerald-500 to-green-600 hidden md:block origin-top"></div>
              ...
              {milestones.map((milestone, idx) => (
                <div key={idx} className={`milestone-item flex flex-col md:flex-row md:items-center gap-6 md:gap-8 ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`w-full md:flex-1 flex justify-center ${idx % 2 === 0 ? 'md:justify-end' : 'md:justify-start'}`}>
                    ...
                    >
                      <div className="milestone-year text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500 font-black text-4xl mb-3">{milestone.year}</div>
                      <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-green-600 transition-colors">{milestone.title}</h3>
                      <p className="text-gray-600">{milestone.desc}</p>
                      <div className="mt-4 w-12 h-1 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full group-hover:w-20 transition-all duration-300"></div>
                    </div>
                  </div>
                  {/* Animated Dot */}
                  <div className="milestone-dot hidden md:flex w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full items-center justify-center shadow-xl z-10 ring-4 ring-white">
      ...
      <section className="team-section py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-gray-900">
              Meet the <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-500">Leaders</span>
            </h2>
          </div>
